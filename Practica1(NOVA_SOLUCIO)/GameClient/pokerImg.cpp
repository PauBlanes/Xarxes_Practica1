...
void pokerImg::setString() {
	str_pocker.push_back(imgAdress + "11-1.jpg");
	...
	str_pocker.push_back(imgAdress + "11-2.jpg");
	...
	str_pocker.push_back(imgAdress + "11-3.jpg");
	...
	str_pocker.push_back(imgAdress + "11-4.jpg");
